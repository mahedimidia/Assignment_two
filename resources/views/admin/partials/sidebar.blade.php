<aside class="bg-gray-800 text-white flex-shrink-0 w-64 relative z-10 flex flex-col" id="sidebar">
            ...
            <div class="flex-grow px-2 py-4 overflow-y-auto">
                <nav class="flex-1 space-y-1">
                    <div>
                        <a href="{{ route('admin.dashboard') }}" class="flex items-center px-3 py-3 text-sm font-medium rounded-md bg-gray-900 text-white">
                    ...
                    <div class="sidebar-dropdown">
                        ...
                        <div class="sidebar-dropdown-menu hidden pl-2 mt-1 space-y-1">
                            <a href="{{ route('categories.create') }}" class="flex items-center px-3 py-2 text-sm rounded-md text-gray-300 hover:bg-gray-700 hover:text-white pl-11">
                                <i class="fas fa-pen mr-3 text-xs"></i>
                                <span>Create Category</span>
                            </a>
                            <a href="{{ route('categories.index') }}" class="flex items-center px-3 py-2 text-sm rounded-md text-gray-300 hover:bg-gray-700 hover:text-white pl-11">
                                <i class="fas fa-folder mr-3 text-xs"></i>
                                <span>Category List</span>
                            </a>
                            <a href="{{ route('post.create') }}" class="flex items-center px-3 py-2 text-sm rounded-md text-gray-300 hover:bg-gray-700 hover:text-white pl-11">
                                <i class="fas fa-pen mr-3 text-xs"></i>
                                <span>Create Posts</span>
                            </a>
                            <a href="{{ route('post.index') }}" class="flex items-center px-3 py-2 text-sm rounded-md text-gray-300 hover:bg-gray-700 hover:text-white pl-11">
                                <i class="fas fa-folder mr-3 text-xs"></i>
                                <span>All Posts</span>
                            </a>
